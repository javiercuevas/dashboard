<?php
	...
	$filename = 'respondent-data.xls'; // file name
    ...
    // queries
    $question_respondent_detail_results = $dashboard->question_respondent_detail_get( 
	...
	// write data to file
	$flag = false;
	foreach( $question_respondent_detail_results as $row ) 
	{
	    if ( !$flag ) 
	    {
