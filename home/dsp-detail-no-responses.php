...
<?php
    ...
    // queries
    $no_responses_results = $dashboard->survey_no_responses_detail_get(
	...
	<div class="col-lg-12">
	    <div class="panel panel-default">
	        <div class="panel-heading">
	            <h3 class="panel-title"><i class="fa fa-table fa-fw"></i> No Responses</h3>
	        </div>
	        <div class="panel-body">
	            <div class="table-responsive">
					...
					<span class="light-gray-sm">This is a list of the contacts that did not respond to the surveys sent</span>
